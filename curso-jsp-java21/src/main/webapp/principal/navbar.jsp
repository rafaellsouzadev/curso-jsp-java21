	...
	<div class="navbar-wrapper">
		<div class="navbar-logo">
			<a class="mobile-menu waves-effect waves-light"
				style="margin-top: auto;" id="mobile-collapse" href="#!"> <i
				class="ti-menu"></i>
			</a>
			...
			<a href="index.html"> <img class="img-fluid"
				style="width: 140px; height: 65px; margin-left: 10px; margin-top: 12px;"
					...
					<div class="main-search morphsearch-search">
						<div class="input-group">
							...
							<span class="input-group-addon search-btn"
								style="margin-top: auto;"><i class="ti-search"></i></span>
						</div>
					</div>
				</li>
				<li><a href="#!" onclick="javascript:toggleFullScreen()"
					style="margin-top: auto;" class="waves-effect waves-light"> <i
						class="ti-fullscreen"></i>
				</a></li>
			</ul>
			<ul class="nav-right" style="margin-top: auto;">
				...
				<li class="user-profile header-notification"><a href="#!"
					class="waves-effect waves-light"> <img
						...
						alt="User-Profile-Image"> <span>Rafael Souza</span> <i
